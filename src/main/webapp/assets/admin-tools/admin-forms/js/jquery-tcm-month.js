...
$.extend(Monthpicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		currentDate = new Date(inst.currentYear+"-"+(inst.currentMonth+1)+"-"+ inst.currentDay);
//		alert(currentDate+"ppppppp"+inst.currentMonth+"MMMMMMMMM"+inst.currentYear+"=="+inst.currentMonth+"=="+ inst.currentDay)
		if (maxDate) {
