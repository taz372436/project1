                  ...
                  case 'sidebarState':
                     if (e === "affix") {
                        ...
                        // Recaculate nano scroller dimensions after affix change
                         ...
                         $('.nano-content').css('overflow-y', 'scroll').css("right","-15px");
                         $("#sidebar_left .nano-pane .nano-slider").css("height","189px!important");
...
//                         });
                        $(".nano-pane").remove();  
                       $("#sidebar_left .nano-pane nano-slider").css("height","10px");
//                       $('.nano-content').css('left', '0px;');
                       $('.nano-content').css('overflow-y', 'hidden').css("right","0px");
...
//                       $(".nano-content").attr('style', '');
                       ...
                       $("#sidebar_left .nano-pane .nano-slider").css("height","10px");
//                       $('.nano-content').css('left', '15px');
//                       $('.nano-content').css('right', '0px');
                       $('.nano-content').css('overflow-y', 'hidden').css("right","0px");
